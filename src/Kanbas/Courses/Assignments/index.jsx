  ...
  return (
    <div id="wd-assignments" className="container mt-4">
      ...
      <ul id="wd-assignment-list" className="list-group rounded-0">
        <li className="wd-assignment-list-item list-group-item p-0 fs-5 border-gray d-flex align-items-center wd-lesson">
      <BsGripVertical className="me-2 fs-3" />
      <IoNewspaperSharp />
      ...
      <ModuleControlChecks />
        ...
        <li className="wd-assignment-list-item list-group-item p-0 mb-5 fs-5 border-gray d-flex align-items-center wd-lesson">
        <BsGripVertical className="me-2 fs-3" />
        <IoNewspaperSharp />
        <div className="p-3 flex-grow-1">
          <a
